...
The global economic system is broken. It ebbs and flows between triumphant rallies and violent crashes. This volatility harms the fiancial and economic well-being of people all around the world. The 2008 financial crisis was only 14 years ago and already we are facing another crisis in 2022 as we are experiencing global supply chain issues, rising energy prices and rampant inflation.

Unfortunately, the global economic system is extremely difficult to fix. It is a [complex system](https://en.wikipedia.org/wiki/Complex_system) in constant motion. Global Think Tanks and G7 economists try to come up with solutions. Yet in reality, there is nothing a small group of people sitting in a board room can do to fix the system. It is too complex!

**We need new systems that evolve from bottom-up tinkering and improvement, with little to no intervention from bureaucratic organizations.** [Local Circular Economies](https://en.wikipedia.org/wiki/Circular_economy), Startup Cities and Cloud Countries are all systems that are being experimented with today, and can exist in tandem alongside the global economic system. 

One thing all these systems have in common is that real economic experiments are being carried out today, and **all of them leverage of Community Currenices, which have become easy to create because of advances made in blockchain and open source technology over the last 5 years.**

Surprisingly, Community Currencies aren't discussed often in the blockchain industry. Yet I believe they will be the driving force behind the most impactful changes in local and global economics in the next decade, and everyone will be familar with them very soon.

They can help solve some of the biggest problems the global economy faces today. For example, a Country may have a stable and wealthy upper class, but a struggling middle and lower class. The US has faced this complex problem for many years, and no solution has been found. The top 1% are much wealthier than the bottom 50%, and it has been getting increasingly worse over the last 40 years.
...
To properly describe Community Currencies, it helps to describe their opposite. The opposite is what we are familar with - fiat currencies, bitcoin, ether, etc. In this post I refer to them as **Network Currencies**. Let's describe both types below:
...
In the 20th and 21st centuries, we have been conditioned to trade, barter, and exchange in Network Currencies. Countries took a centralized role in our lives and completely monopolized the economy for themselves. This lead to a total dependency on Fiat Currencies, which then lead to a global economy powered by the USD.

As a result, we have all been forced into economies that fluctuate and whipsaw with instability. We are going through a particularly unstable time in the 2020s, which was initiated by the COVID crisis, and is continuing with the War in Ukraine.
...
It is worth pointing out that Network and Community Currencies can be centralized or decentralized, and both are okay! Fully decentralized currencies have more potential because they didn't exist before and are filling a large void. But a coin that is deliberately, and honestly centralized, is totally fine. It's more like a traditional business. Let's breakdown the differences:
...
- The perfect example for a Centralized Network Currency is Binance’s BNB. Binance is on the path to becoming a global bank and comply with national governments. BNB will never be decentralized. But that's okay! Centralized Network Currencies are fulfilling the original vision of "Fintech". Fintech was unable to create significant change in banking because startups had to follow strict banking regulations. This created a stale, slow-moving financial tech sector. Binance is just stepping in to speed this path up. (*Of course this means in a decade that Binance will be more powerful than any bank and will very likely be an evil company, but that's a story for another day*.)
- Fiat Currencies are also Centralized Network Currencies, as the government or the central bank has root access to change the supply and freeze any account.

**Centralized Community Currencies**

- Many Community Currencies will have characteristics of centralization. For example, Having a Proof of Authority (POA) network for a village or city of fewer than 10,000 people makes sense. The community is so small, it does not need to achieve the level of decentralization that Bitcoin has.
- It should be open and transparent to the members of the community.
- If the currency is to be used by people outside of the community, it has to be open and transparent to them as well.
- It can be temporary - designed to last only one week or one day.

**Decentralized Community Currencies**

- A City Coin is a good example of a Decentralized Community Currency.
- For example, imagine that New York had a token. The token could be programmed to work differently for residents and tourists. The token should be decentralized enough that the tourist is confident they won't get rug pulled.
- It also needs to be decentralized enough so that worldwide Investors could buy NYC token and be confient the city doesn't rug pull.
...
Let's now explore some the benefits and problems of the USD - the world's most widely adopted Network Currency.
...
### USD Problems
Of course, many of the benefits stated above end up causing some of the problems the USD has: 

- Controlling the money supply allows governments to print money at will. In crises they always inflate their currency. Every currency ever created has faced massive devaulation from inflation.
- [Fiscal](https://www.investopedia.com/terms/f/fiscalpolicy.asp) and [monetary](https://www.investopedia.com/terms/m/monetarypolicy.asp) intervention is often done with a short-term outlook, usually an election cycle. This leads to crises and bubbles as problems get worse under the surface, until the government can no longer control a violent crash.
- The violent crashes lead to slow, uneven recovery.
- All of the planning happens behind closed door meetings at The Federal Reserve. This small group decides everything about the USD. They can inflate the currency extremely fast and cause harships to business operations and people's savings. Their decisions affect billions of people around the world, which is a receipe for distaster.
...
- Prone to big rallies and bubbles.
...
Ethereum is also a great example of a Network Currency. It has different benefits and problems than Bitcoin but I won't dig into them, as this debate is well known!
...
$SPORK was rewarded to people who have participated in past ETH Denver events, and there are plans to distribute $SPORK to encourage future membership. It will also be used to govern the DAO. [REFERENCE]
...
ETH Denver did something pretty cool with Food Tokens as well! Attendees were given 3 Food Tokens each, which were ERC-20 tokens on the Rinkeby Testnet. Each token was worth about $10 USD. Food Trucks positioned outside the event accepted these tokens as payment. After the event they exchange the tokens for real money with the ETH Denver organizers.
...
Again, this is a super small example! But what is so amazing about it is that we have open-source technology that allows this to be adopted by any community worldwide. One day anyone with an internet connection will be able to create a temporary community currency from their phone in a few clicks.
...
[Grassroots Economics](https://www.grassrootseconomics.org/pages/about-us.html) is a non-profit foundation that is empowering marginalized communities to take control of their own economic future. They have been around for over a decade, and have boots on the ground in low-income rural communities. They have been working on Community Currencies for a long time, and [they have begun to leverage blockchain and open source technology to their benefit](https://www.grassrootseconomics.org/open-tech-questions-answers.html).
 ...
 I love that they don't treat blockchains as something to speculate and get rich quick with. They simply use it as a tool in their arsenal to help improve local communities economic situation. It's a breath of fresh air!
...
**Communities get to decide how intertwined they want their currency to be with other currencies. They have economic self-soverignty**. They could bridge up to Kenyan Shillings aggressively, or try to keep their economy more closed loop and in their control. It's totally up to them! And that's what makes it so powerful.
...
[Citycoins](https://www.citycoins.co/) **is a project that creates a token for an existing city**. They use an interesting approach - they get no approval or partnership with the city to start. They aim for a grassroots movement of citizens and/or speculators to mine the token. In order to mine the token, they must send Stacks tokens (**$STX**) to the CityCoin smart contract on the Stacks Blockchain. Then the official City Treasury can claim 30% of the total $STK that has been staked by the users to mine the City Coin. The first city to launch a token was Miami. Later on, CityCoin was able to get in contact with the City of Miami, and Miami ended up claiming over $5,000,000 in $STX for their treasury, as announced by the Mayor of Miami.
...
Now let's look into the future and see where Community Currencies will take us.
...
A circular economy is _"a model of production and consumption, which involves sharing, leasing, reusing, repairing, refurbishing and recycling existing materials and products as long as possible"_. [REFERENCE](https://en.wikipedia.org/wiki/Circular_economy)

This is exactly the system we need. Our current global economics are broken in many places. In the 2020s, COVID and The Russia-Ukraine War have contributed to huge supply chain issues and the most inflation we've seen in +40 years.

**But ANY external crisis could have exacerbated inflation and supply chain issues because the global system is broken!** The ["Just in Time"](https://www.investopedia.com/ask/answers/040215/what-are-main-problems-jit-just-time-production-strategy.asp#:~:text=While%20this%20streamlined%20approach%20can,and%20worsen%20an%20economic%20downturn.) delivery of materials makes the global supply chain extremely fragile. [A ship getting stuck in the Suez Canal](https://en.wikipedia.org/wiki/2021_Suez_Canal_obstruction) caused global supply chain issues. Imagine what a single bomb could do to a major trade route. These are just examples. There are many more fragile attack points in the global supply chain.
...
**I believe the first Circular Economies that have success will be powered by Community Currencies.** It will be bottom-up, and start with small communities solving the easiest things first. Previously we did not have the technology to pull it off from the bottom-up. But blockchains and Community Currencies are changing that.

Let's look at global recycling and local circular recycling to compare the two systems, and see how circular economics can succeed where globalization has failed.

### Globalization Sucks for Recycling

Recycling has many inputs and outputs and is very complex. There are many different actors are involved in decisions:

- National, State, and City officials.
- Citizens.
- Collectors who take it to a recycling plant. Which are usually employees at city orgnaizations or private corporations that are contracted to do the collecting.
- The corporation that owns the recycling plant and does the recycling.

Recycling requires citizens to make millions of daily decisions to sort the recycling properly. The guidelines of how to recycle come from a top-down government organization. Although the spirit of the guidelines are good, it's really hard to make sure 100's of millions of people follow these guidelines. In reality we end up with lots of recycling and garbage mixed together, due to citizens not understanding what items can be recycled, or being too lazy to separate it themselves.

The system then fails further down the pipeline with some pretty bizarre behavior. [Modern countries end up shipping their unorganized recycling to foreign countries](https://www.bbc.com/news/world-48444874). It's a ludicrous idea, we are burning oil to ship recycling 1000's of miles away, but the global system almost encourages it to happen. On paper, the modern country is allowed to write off the material as **_recycled_**. The material becomes an output for the modern country, and an input to the foreign country.

The foreign country is a black box to the modern country. It is left up to the corporation in the foreign country to decide if and how to recycle the material. Sometimes the Modern country does such a poor job of separating the recycling from garbage, that the foriegn company decides it is too costly to seprate it, and they just dump it in a landfill. [REFERENCE NEEDED] Other times they just dump it in a landfill to make more profit, and lie to the modern country and tell them they recycled it.
...
/>
<div className='caption'>
  The global economy enables a recycling system with too many actors, too many black boxes, and too many decisions, that make it impossible to track recycling.
</div>

Recycling is just an example of many processes that don't work well on a global scale. Textiles, construction, and the automobile industries are bad for it too. **We have to blame the crux of the issue. The global economic machine is a complex system with many different actors and there is no solution that a government organization or think tank can create that will work in practice.**
...
Let's use a neighbourhood in a large city as an example. First, get some businesses to adopt the usage of recyclable containers by rewarding them some of the city coins. Then, when citizens come in give them the reusable containers for free. As the citizens and the businesses use the recycling program, they each get small rewards. The early adopters will drive the intial change, and with success it will drive other businesses and citizens to join the system. The early adopters should be rewarded for their pioneering efforts with more city coins, or free benefits or services.

The coin could also be used to reward citizens and businesses that buy and use food and materials within a 50km radius. This saves food transporation costs and reduces packaging. Or to encourage biodegradeable materials, or propse use of compost.

**Using the community currency as incentivization is the key. Recycling programs like this have not had success because they face a chicken and egg problem.** It's obvious everyone wants to be help with recycling, but no business wants to be the first to try to push it. It will eat into their bottom line to change their system. And they are likely to fail to convince all their customers and other local businesses to join them.

**Local economics enables circular economies to form and be tested at a small scale. The feedback loop within a community is small enough to make quick adjustments, and to improve the process.** What is so powerful is that 100's of communities around the world can be working on similar concepts. Building on top of open source technology means that a city like Miami might lay a lot of ground work for decentralized applications that run with community currencies. Then Minneapolis could come along and copy their dapp completely, or fork it and adjust it as they see fit. Slowly, and then all at once, we will see community currencies adopted in this way.

### Startup Cities

Startup Cities are a concept [Balaji Srinivasan](https://twitter.com/balajis) has discussed in depth. Cities and towns now have an incredible opportunity to compete with major cities like New York or London. Community Currencies will enable fast capital allocation to grow these startup cities. There are a lot of different ways a startup city can come to life. CityDAO in Wyoming is one way to go about it.
<Image
...
The success of startup cities will also drive much-needed innovation in traditional cities. Big cities stop innovating due to problems like [NIMBYism](https://en.wikipedia.org/wiki/NIMBY). As startup cities become successful, older cities will have to react. It is too easy to work remotely. A lot of people will realize that the benefit to live in some of these older cities does not justify the cost. Eventually, older cities will have to start treating their citizens like customers.
...
A City token can be used to tie into all of the above. We'll also see cities leverage NFTs to represent land ownership and identity.

### Network States / Cloud Countries

[Network States (aka Cloud Countries) are another idea of Balaji's](https://1729.com/how-to-start-a-new-country). It is even more ambitious and futuristic than Startup Cities. But as with most things Balaji writes about, it's incredibly well thought out and is likely to become reality. [He has a book coming out this summer](https://www.amazon.com/dp/B09VPKZR3G) which I will definetly be ordering. 

<Image
  src="/images/community-currencies/the-network-state2.png"
  alt="The Network State Book"
  layout="responsive"
  height={462}
  width={918}
/>
<div className='caption'>
  <Link href="https://www.amazon.com/dp/B09VPKZR3G">
    <a target="_blank">
      Balajis new book.
    </a>
  </Link>
...
I'll provide a short description of what a Network State is: 
...
- The community can grow to be large, diverse, and have a ton of capital. This can all be done online and at low cost.
- Eventually when the community is big enough and rich enough, they can start buying physical property.
- The Cloud Country can purchase land in different cities and countires. It can provide its citizens with housing, food, and security all over the world.
- The Cloud County could also try to incentivize specific citizens or businesses to join them. Someone with a cattle ranch might be able to shop around between different Cloud Countries and decide which one they should join.
- The capital will always be in the cloud, ownership represented on-chain, governance on-chain.

We are likely still far away from seeing a Cloud Country come to fruition. Soon we will get real estate, energy, farming, and waste management onto blockchains and open ledgers. As this becomes more commonplace, and more communities experiment with currencies, we will see Cloud Countries start to form in a bottom-up, decentralized fashion.

## "Shopifying" Community Currencies

**The key point to take away from this blog is that the open source tools and technology we are building are the catalyst that will make real bottom-up economic change possible.** We are moving at incredible speeds for innovation, as we are all building in the open, incentivized by tokens.

Creating and managing a community will become a simple plug-and-play process. It will be a Shopify-like experience for Communities to run on. We can build out distributed and connected local economies, and save countless hours of human productivity. Everytime a community builds a new plugin, it can be resued by any other community. Let's list some categories of "plugins" that already exist.
...
These new local economic systems need to grow exponentially, and then operate in tandem with the global system. Having both systems provides resilience for the world, as the two systems compliment each other and offer some redundancy.

**The exponential growth of local economic systems will be enabled by open source blockchain technology, particularily Community Currencies. We have open source tools that allow anyone with software development skills to launch Communities from 10 people to over a million. Soon enough it'll be as easy to start a community with this technology, as it is to build an e-commerce business with Shopify. This will lead to a proliferation of local econcomic systems that change the way we do business and economics in the next decade.**
