...
What interests me the most, as Balaji described in his tweet, is the possibility of a City Coin to open up speculation on the cities success or decline. Historically, the real estate market of a city has acted as a proxy for the cities success. It will be interesting to see if there can be a decoupling, which might make cities more affordable to live in.
...
## What can Communties do to build with City Tokens? i.e. What is so exciting about this stuff? (this seems like a good SOLUTION to the PROBLEMS we have, i.e. end to the blog)
...
- Balaji tweet 
  - municiple bonds existed a long time, but not many trade them
  - each city coin to become unique itself
  - token locking of the token, getting you city privlidges
  - remote economy gives HUGE competetion betweens cities around the world
  - startup cities
- Clans and stuff
